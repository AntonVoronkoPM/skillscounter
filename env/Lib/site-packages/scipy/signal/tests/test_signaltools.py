    ...
    def test_fillvalue_deprecations(self):
        ...
        with suppress_warnings() as sup:
            ...
            warnings.filterwarnings(
                "error", message="could not cast `fillvalue`", category=DeprecationWarning
            )
        ...
        with suppress_warnings():
            ...
            assert_warns(DeprecationWarning, convolve2d, [[1]], [[1, 2]], fillvalue=[1, 2])
            warnings.filterwarnings(
                "error",
                message="`fillvalue` must be scalar or an array ",
                category=DeprecationWarning,
            )
            assert_raises(DeprecationWarning, convolve2d, [[1]], [[1, 2]], fillvalue=[1, 2])
