...
class TestTnc(object):
    ...
    def test_tnc1(self):
        ...
        x, nf, rc = optimize.fmin_tnc(
            fg, x, bounds=bounds, args=(100.0,), messages=optimize.tnc.MSG_NONE, maxfun=200
        )
    ...
    def test_tnc1b(self):
        ...
        x, nf, rc = optimize.fmin_tnc(
            self.f1, x, approx_grad=True, bounds=bounds, messages=optimize.tnc.MSG_NONE, maxfun=200
        )
    ...
    def test_tnc1c(self):
        ...
        x, nf, rc = optimize.fmin_tnc(
            self.f1, x, fprime=self.g1, bounds=bounds, messages=optimize.tnc.MSG_NONE, maxfun=200
        )
