...
class TestDifferentialEvolutionSolver(object):
    ...
    def test_random_generator(self):
        ...
        for init in inits:
            differential_evolution(
                self.quadratic, [(-100, 100)], polish=False, seed=rng, tol=0.5, init=init
            )
    ...
    def test_L1(self):
        ...
        with suppress_warnings() as sup:
            ...
            res = differential_evolution(
                f, bounds, strategy="rand1bin", seed=1234, constraints=constraints, popsize=2
            )
    ...
    def test_L4(self):
        ...
        with suppress_warnings() as sup:
            sup.filter(UserWarning)
            res = differential_evolution(
                f, bounds, strategy="rand1bin", seed=1234, constraints=constraints, popsize=3
            )
