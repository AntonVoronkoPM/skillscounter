...
def configuration(parent_package="", top_path=None):
    ...
    config.add_extension(
        ...
        depends=(["rectangular_lsap/rectangular_lsap.cpp", "rectangular_lsap/rectangular_lsap.h"]),
        include_dirs=include_dirs,
        **numpy_nodepr_api
    )
    ...
    config.add_library("rootfind", sources=rootfind_src, headers=rootfind_hdr, **numpy_nodepr_api)
    ...
    ext = config.add_extension(
        "__nnls", sources=[join("__nnls", x) for x in ["nnls.f", "nnls.pyf"]], **numpy_nodepr_api
    )
    ext._pre_build_hook = gfortran_legacy_flag_hook
