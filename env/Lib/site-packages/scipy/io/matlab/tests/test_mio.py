...
from scipy.io.matlab.mio import loadmat, mat_reader_factory, savemat, whosmat
...
from scipy.io.matlab.miobase import MatReadError, MatWriteError, matdims
...
def _check_level(label, expected, actual):
    ...
    if SP.issparse(expected):  # allow different types of sparse matrices
        ...
        assert_array_almost_equal(actual.todense(), expected.todense(), err_msg=label, decimal=5)
        return
...
def test_gzip_simple():
    ...
    assert_array_almost_equal(actual["x"].todense(), expected["x"].todense(), err_msg=repr(actual))
