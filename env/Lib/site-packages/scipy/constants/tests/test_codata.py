...
from scipy.constants import ConstantWarning, codata, constants, find, value
...
def test_basic_lookup():
    assert_equal("%d %s" % (codata.c, codata.unit("speed of light in vacuum")), "299792458 m s^-1")
...
def test_find_single():
    assert_equal(
        codata.find("Wien freq", disp=False)[0], "Wien frequency displacement law constant"
    )


def test_2002_vs_2006():
    assert_almost_equal(codata.value("magn. flux quantum"), codata.value("mag. flux quantum"))
