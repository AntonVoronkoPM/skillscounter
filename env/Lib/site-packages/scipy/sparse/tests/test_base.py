...
class _TestCommon(object):
    ...
    def test_round(self):
        ...
        assert_equal(
            np.around(A, decimals=decimal), round(self.spmatrix(A), ndigits=decimal).todense()
        )
    ...
    def test_reshape(self):
        ...
        for order in ["C", "F"]:
            for s in [(12, 1), (1, 12)]:
                assert_array_equal(
                    x.reshape(s, order=order).todense(), x.todense().reshape(s, order=order)
                )
...
class _TestFancyIndexing(object):
    ...
    def test_fancy_indexing(self):
        ...
        assert_equal(
            A[array([[-1], [-3], [-2]]), [2, -4]].todense(), B[[[-1], [-3], [-2]], [2, -4]]
        )
        assert_equal(
            A[[[-1], [-3], [-2]], array([2, -4])].todense(), B[[[-1], [-3], [-2]], [2, -4]]
        )
        assert_equal(
            A[array([[-1], [-3], [-2]]), array([2, -4])].todense(), B[[[-1], [-3], [-2]], [2, -4]]
        )
...
class TestLIL(sparse_test_class(minmax=False)):
    ...
    def test_point_wise_multiply(self):
        ...
        assert_array_equal(l.multiply(m).todense(), [[1, 0, 0], [0, 0, 0], [0, 0, 9], [0, 16, 0]])
