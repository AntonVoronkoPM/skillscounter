...
from .sputils import get_index_dtype, upcast
...
class csr_matrix(_cs_matrix):
    ...
    def getrow(self, i):
        ...
        return csr_matrix((data, indices, indptr), shape=(1, N), dtype=self.dtype, copy=False)
    ...
    def getcol(self, i):
        ...
        return csr_matrix((data, indices, indptr), shape=(M, 1), dtype=self.dtype, copy=False)
