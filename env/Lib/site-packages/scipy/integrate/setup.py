...
def configuration(parent_package="", top_path=None):
    ...
    config.add_library(
        "mach", sources=mach_src, config_fc={"noopt": (__file__, 1)}, _pre_build_hook=pre_build_hook
    )
    ...
    cfg = combine_dict(lapack_opt, include_dirs=include_dirs, libraries=["quadpack", "mach"])
    ...
    # dop
    ext = config.add_extension(
        "_dop", sources=["dop.pyf"], libraries=["dop"], depends=dop_src, f2py_options=f2py_options
    )
    ext._pre_build_hook = pre_build_hook
