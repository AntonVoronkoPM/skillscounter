...
from numpy.distutils.system_info import get_info as old_get_info
from numpy.distutils.system_info import numpy_info, system_info
...
if _pep440.parse(np.__version__) >= _pep440.Version("1.15.0.dev"):
    ...
    def get_info(name, notfound_action=0):
        ...
        cls = {"lapack_opt": lapack_opt_info, "blas_opt": blas_opt_info}.get(name.lower())
        if cls is None:
