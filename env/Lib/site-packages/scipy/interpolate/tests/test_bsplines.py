...
from scipy.interpolate._bsplines import _augknt, _not_a_knot
...
class TestBSpline(object):
    ...
    def test_integral(self):
        ...
        t, c, k = b.tck
        assert_allclose(b.integrate(1, -1, extrapolate=False), _splint(t, c, k, 1, -1)[0])
...
class TestInterop(object):
    ...
    @pytest.mark.xfail(
        _pep440.parse(np.__version__) < _pep440.Version("1.14.0"), reason="requires NumPy >= 1.14.0"
    )
...
class TestInterp(object):
    ...
    def test_complex(self):
        ...
        assert_allclose(b(xx), yy, atol=1e-14, rtol=1e-14)
        assert_allclose(
            [b(xx[0], 1), b(xx[-1], 1)], [der_l[0][1], der_r[0][1]], atol=1e-14, rtol=1e-14
        )
