...
class TestCircFuncs(object):
    @pytest.mark.parametrize(
        "test_func,expected",
        [(stats.circmean, 0.167690146), (stats.circvar, 42.51955609), (stats.circstd, 6.520702116)],
    )
    ...
    def test_circmean_axis(self):
        x = np.array(
            [[355, 5, 2, 359, 10, 350], [351, 7, 4, 352, 9, 349], [357, 9, 8, 358, 4, 356]]
        )
        ...
        [
            ...
            (
                stats.circvar,
                {
                    ...
                    0: np.array(
                        [4.00081258, 1.00005077, 1.00005077, 12.25762620, 0.25000317, 0.25000317]
                    ),
