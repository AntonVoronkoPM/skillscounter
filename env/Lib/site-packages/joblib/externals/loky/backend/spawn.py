...
def get_preparation_data(name, init_main_module=True):
    ...
    if sys.platform == "win32":
        child_w = duplicate(msvcrt.get_osfhandle(_resource_tracker._fd), inheritable=True)
    ...
    if sys.version_info >= (3, 8) and os.name == "posix":
        ...
        d["mp_tracker_args"] = {"fd": mp_resource_tracker._fd, "pid": mp_resource_tracker._pid}
