...
from .backend.compat import queue, set_cause, wait
from .backend.context import cpu_count
from .backend.queues import Queue, SimpleQueue
from .backend.reduction import get_loky_pickler_name, set_loky_pickler
from .backend.utils import get_exitcodes_terminated_worker, recursive_terminate
...
class _CallItem(object):
    ...
    def __repr__(self):
        return "CallItem({}, {}, {}, {})".format(self.work_id, self.fn, self.args, self.kwargs)
...
class ProcessPoolExecutor(_base.Executor):
    ...
    def map(self, fn, *iterables, **kwargs):
        ...
        results = super(ProcessPoolExecutor, self).map(
            partial(_process_chunk, fn), _get_chunks(chunksize, *iterables), timeout=timeout
        )
