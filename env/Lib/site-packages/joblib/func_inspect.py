    ...
    **kwargs: dict
    ...
    if arg_spec.kwonlydefaults:
        arg_defaults = arg_defaults + tuple(
            arg_spec.kwonlydefaults[k] for k in arg_spec.kwonlyargs if k in arg_spec.kwonlydefaults
        )
            ...
            if arg_name in kwargs:
                ...
                try:
                    ...
                    raise ValueError(
                        ...
                        "     %s was called."
                        % (_signature_str(name, arg_spec), _function_called_str(name, args, kwargs))
                    ) from e
