...
class SQLDatabase(PandasSQL):
    ...
    def execute(self, *args, **kwargs):
        ...
        return self.connectable.execution_options(no_parameters=True).execute(*args, **kwargs)
    ...
    def _create_sql_schema(self, frame, table_name, keys=None, dtype=None):
        table = SQLTable(table_name, self, frame=frame, index=False, keys=keys, dtype=dtype)
