...
class TestAsOfMerge:
    ...
    def test_allow_exact_matches_and_tolerance2(self):
        ...
        df2 = pd.DataFrame(
            {
                "time": pd.to_datetime(["2016-07-15 13:30:00.000", "2016-07-15 13:30:00.030"]),
                "version": [1, 2],
            }
        )
    ...
    def test_allow_exact_matches_and_tolerance3(self):
        ...
        df1 = pd.DataFrame(
            {
                "time": pd.to_datetime(["2016-07-15 13:30:00.030", "2016-07-15 13:30:00.030"]),
    ...
    def test_left_index_right_index_tolerance(self):
        ...
        dr1 = pd.date_range(start="1/1/2020", end="1/20/2020", freq="2D") + pd.Timedelta(
            seconds=0.4
        )
