...
# TODO(extension)
@pytest.mark.xfail(
    reason=("raising AssertionError as this is not implemented, though easy enough to do")
)
...
def test_combine_from_sequence_raises():
    ...
    ser = pd.Series(
        DecimalArrayWithoutFromSequence([decimal.Decimal("1.0"), decimal.Decimal("2.0")])
    )
