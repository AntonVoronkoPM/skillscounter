...
class TestGroupBy:
    def test_groupby_with_timegrouper(self):
        ...
        for df in [df_original, df_reordered]:
            ...
            expected = DataFrame(
                {"Quantity": 0},
                index=date_range("20130901", "20131205", freq="5D", name="Date", closed="left"),
            )
    ...
    def test_timegrouper_with_reg_groups(self):
        ...
        for df in [df_original, df_sorted]:
            ...
            with pytest.raises(ValueError, match=msg):
                df.groupby([pd.Grouper(freq="1M", key="Date", level="Date"), "Buyer"]).sum()
    ...
    def test_timegrouper_with_reg_groups_freq(self, freq):
        ...
        result1 = df.sort_index().groupby([pd.Grouper(freq=freq), "user_id"])["whole_cost"].sum()
...
4,2000-01-01 16:50:00,America/New_York"""
    ...
    def test_grouper_period_index(self):
        ...
        expected = pd.Series(
            range(0, periods),
            index=Index(range(1, periods + 1), name=index.name),
        )
        tm.assert_series_equal(result, expected)
