...
class TestGetItem:
    ...
    def test_getitem(self):
        ...
        for idx in [idx1, idx2]:
            ...
            result = idx[0:5]
            expected = pd.date_range("2011-01-01", "2011-01-05", freq="D", tz=idx.tz, name="idx")
            tm.assert_index_equal(result, expected)
            assert result.freq == expected.freq

            result = idx[0:10:2]
            expected = pd.date_range("2011-01-01", "2011-01-09", freq="2D", tz=idx.tz, name="idx")
            tm.assert_index_equal(result, expected)
            assert result.freq == expected.freq

            result = idx[-20:-5:3]
            expected = pd.date_range("2011-01-12", "2011-01-24", freq="3D", tz=idx.tz, name="idx")
            tm.assert_index_equal(result, expected)
            assert result.freq == expected.freq
...
class TestGetIndexer:
    ...
    def test_get_indexer_mixed_dtypes(self, target):
        ...
        values = pd.DatetimeIndex([pd.Timestamp("2020-01-01"), pd.Timestamp("2020-01-02")])
