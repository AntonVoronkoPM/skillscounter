...
def check_binary_ew_min_periods(name, min_periods, A, B):
    ...
    result = ew_func(Series([1.0]), Series([1.0]), 50, name=name, min_periods=min_periods)
...
def moments_consistency_var_debiasing_factors(x, var_biased, var_unbiased, var_debiasing_factors):
