...
class TestSeriesDtypes:
    ...
    def test_astype_categorical_to_other(self):
        ...
        tm.assert_series_equal(s.astype("object").astype("category"), roundtrip_expected)
        tm.assert_series_equal(s.astype("object").astype(CategoricalDtype()), roundtrip_expected)
