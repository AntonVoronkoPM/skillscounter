...
class TestAstype:
    ...
    def test_astype_extension_dtypes(self, dtype):
        ...
        expected2 = DataFrame({"a": [1.0, 3.0, 5.0], "b": integer_array([2, 4, 6], dtype=dtype)})
    ...
    def test_astype_to_incorrect_datetimelike(self, unit):
        ...
        msg = (
            rf"cannot astype a datetimelike from \[datetime64\[ns\]\] to "
            rf"\[timedelta64\[{unit}\]\]"
        )
        ...
        msg = (
            rf"cannot astype a timedelta from \[timedelta64\[ns\]\] to "
            rf"\[datetime64\[{unit}\]\]"
        )
        ...
        expected = DataFrame(
            {
                ...
                "C": (
                    date_range("20130101", periods=3, tz="CET").tz_convert("UTC").tz_localize(None)
                ),
            }
        )
