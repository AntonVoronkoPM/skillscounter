...
class TestDataFrameDataTypes:
    ...
    def test_empty_frame_dtypes(self):
        ...
        ex_dtypes = pd.Series(odict([("a", np.int64), ("b", np.bool_), ("c", np.float64)]))
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # multi-extension
            (
                DataFrame({"A": pd.Categorical(["a", "b"]), "B": pd.Categorical(["a", "b"])}),
                True,
            ),
            # differ types
            ...
            (
                DataFrame({"A": pd.Categorical(["a", "b"]), "B": pd.Categorical(["b", "c"])}),
                False,
            ),
        ],
    )
