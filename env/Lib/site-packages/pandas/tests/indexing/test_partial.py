...
class TestPartialSetting:
    ...
    def test_series_partial_set(self):
        ...
        msg = r"\"None of \[Int64Index\(\[3, 3, 3\], dtype='int64'\)\] are " r"in the \[index\]\""
    ...
    def test_loc_with_list_of_strings_representing_datetimes(self, idx, labels, expected_idx):
        # GH 11278
    ...
    def test_index_name_empty(self):
        ...
        df["series"] = series
        expected = pd.DataFrame({"series": [1.23] * 4}, index=pd.RangeIndex(4, name="df_index"))
