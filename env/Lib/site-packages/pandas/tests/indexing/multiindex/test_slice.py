...
class TestMultiIndexSlicers:
    def test_per_axis_per_level_getitem(self):
        ...
        expected = df.loc[
            [
                tuple([a, b, c, d])
                for a, b, c, d in df.index.values
                if (a == "A1" or a == "A2" or a == "A3") and (c == "C1" or c == "C2" or c == "C3")
            ]
        ]
    ...
    def test_multiindex_slicers_datetimelike(self):
        ...
        dates = [
            datetime.datetime(2012, 1, 1, 12, 12, 12) + datetime.timedelta(days=i) for i in range(6)
        ]
        freq = [1, 2]
    ...
    def test_per_axis_per_level_doc_examples(self):
        ...
        expected = df.loc[
            [tuple([a, b, c, d]) for a, b, c, d in df.index.values if (c == "C1" or c == "C3")]
        ]
        tm.assert_frame_equal(result, expected)
    ...
    def test_loc_axis_single_level_multi_col_indexing_multiindex_col_df(self):
        ...
        df = pd.DataFrame(
            ...
            columns=pd.MultiIndex.from_product([["a1", "a2", "a3"], ["b1", "b2", "b3"]]),
        )
