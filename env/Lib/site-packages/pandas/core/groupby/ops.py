...
class BaseGrouper:
    ...
    def _cython_operation(
        ...
        if is_datetime64tz_dtype(orig_values.dtype) or is_period_dtype(orig_values.dtype):
    ...
    def _aggregate_series_pure_python(
        ...
        **kwargs,
        ...
        if maybe_use_numba(engine):
            numba_func, cache_key = generate_numba_func(func, engine_kwargs, kwargs, "groupby_agg")
