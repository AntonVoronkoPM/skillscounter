...
b  2""",
    ...
    def _python_agg_general(self, func, *args, engine="cython", engine_kwargs=None, **kwargs):
        func = self._is_builtin_func(func)
        if engine != "numba":
    ...
    **Attributes**
    ...
    def _reindex_output(
        ...
        # reindexing only applies to a Categorical grouper
            ...
            isinstance(ping.grouper, (Categorical, CategoricalIndex)) for ping in groupings
        ):
            return output
    ...
    def sample(
        ...
        samples = [
            obj.sample(n=n, frac=frac, replace=replace, weights=w, random_state=random_state)
