...
def _map_stringarray(
    ...
    if is_integer_dtype(dtype) or is_bool_dtype(dtype):
        ...
        # i.e. StringDtype
        result = lib.map_infer_mask(arr, func, mask.view("uint8"), convert=False, na_value=na_value)
...
class StringMethods(NoNewAttributesMixin):
    ...
    @Appender(
        _shared_docs["str_strip"] % dict(side="left side", method="lstrip", position="leading")
    )
    @forbid_nonstring_types(["bytes"])
    ...
    @Appender(
        _shared_docs["str_strip"] % dict(side="right side", method="rstrip", position="trailing")
    )
    @forbid_nonstring_types(["bytes"])
    ...
    startswith = _pat_wrapper(str_startswith, na=True, name="startswith", returns_string=False)
    endswith = _pat_wrapper(str_endswith, na=True, name="endswith", returns_string=False)
    findall = _pat_wrapper(str_findall, flags=True, name="findall", returns_string=False)
    ...
    _doc_args["capitalize"] = dict(type="be capitalized", method="capitalize", version="")
