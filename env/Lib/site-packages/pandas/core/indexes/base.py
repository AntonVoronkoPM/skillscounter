...
class Index(IndexOpsMixin, PandasObject):
    ...
    def _format_with_header(self, header: List[str_t], na_rep: str_t = "NaN") -> List[str_t]:
    ...
    def _validate_sort_keyword(self, sort):
        if sort not in [None, False]:
            raise ValueError(
                "The 'sort' keyword only takes the values of " f"None or False; {sort} was passed."
            )
    ...
    def set_value(self, arr, key, value):
        ...
        """
        warnings.warn(
            ("The 'set_value' method is deprecated, and " "will be removed in a future version."),
            FutureWarning,
            stacklevel=2,
        )
...
def _try_convert_to_int_array(data: np.ndarray, copy: bool, dtype: np.dtype) -> np.ndarray:
    """
