...
class Block(PandasObject):
    ...
    @classmethod
    def _simple_new(cls, values: ArrayLike, placement: BlockPlacement, ndim: int) -> "Block":
        """
    ...
    def fillna(self, value, limit=None, inplace: bool = False, downcast=None) -> List["Block"]:
        """
    ...
    def coerce_to_target_dtype(self, other):
        ...
        if self.is_bool or is_object_dtype(dtype) or is_bool_dtype(dtype):
            ...
            # not a datetime
            if not (
                (is_datetime64_dtype(dtype) or is_datetime64tz_dtype(dtype)) and self.is_datetime
            ):
                return self.astype(object)
    ...
    def quantile(self, qs, interpolation="linear", axis: int = 0):
        ...
        if is_empty:
            ...
            result = np.repeat(np.array([self.fill_value] * len(qs)), len(values)).reshape(
                len(values), len(qs)
            )
        else:
...
class FloatBlock(FloatOrComplexBlock):
    ...
    def _can_hold_element(self, element: Any) -> bool:
        ...
        return isinstance(element, (float, int, np.floating, np.int_)) and not isinstance(
            element,
...
class ComplexBlock(FloatOrComplexBlock):
    ...
    def _can_hold_element(self, element: Any) -> bool:
        ...
        return isinstance(element, (float, int, complex, np.float_, np.int_)) and not isinstance(
            element, (bool, np.bool_)
        )
...
class DatetimeBlock(DatetimeLikeBlockMixin, Block):
    ...
    def to_native_types(self, na_rep="NaT", date_format=None, **kwargs):
        ...
        result = dta._format_native_types(na_rep=na_rep, date_format=date_format, **kwargs)
