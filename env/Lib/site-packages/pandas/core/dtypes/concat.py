...
def union_categoricals(to_union, sort_categories: bool = False, ignore_order: bool = False):
    """
    ...
    if not all(
        is_dtype_equal(other.categories.dtype, first.categories.dtype) for other in to_union[1:]
    ):
