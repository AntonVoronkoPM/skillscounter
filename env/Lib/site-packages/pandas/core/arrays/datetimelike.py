...
class AttributesMixin:
    ...
    def _check_compatible_with(self, other: DTScalarOrNaT, setitem: bool = False) -> None:
        """
...
class DatetimeLikeArrayMixin(ExtensionOpsMixin, AttributesMixin, NDArrayBackedExtensionArray):
    """
    ...
    def _validate_fill_value(self, fill_value):
        ...
        ValueError
        """
        msg = f"'fill_value' should be a {self._scalar_type}. " f"Got '{str(fill_value)}'."
        try:
    ...
    def _validate_scalar(self, value, msg: Optional[str] = None, cast_str: bool = False):
        """
    ...
    def _validate_listlike(
        ...
        if allow_object and is_object_dtype(value.dtype):
            ...
            raise TypeError(
                f"{opname} requires compatible dtype or scalar, " f"not {type(value).__name__}"
            )
