...
class Factory(object):
    ...
    def find_candidates(
        ...
        return (
            c for c in explicit_candidates if all(req.is_satisfied_by(c) for req in requirements)
        )
    ...
    def _report_requires_python_error(
        ...
        message_format = (
            "Package {package!r} requires a different Python: " "{version} not in {specifier!r}"
        )
