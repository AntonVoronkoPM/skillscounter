...
class TestFinancial:
    ...
    def test_mirr_decimal(self):
        ...
        assert_equal(
            np.mirr(val, Decimal("0.10"), Decimal("0.12")), Decimal("0.126094130365905145828421880")
        )

        val = [Decimal("100"), Decimal("200"), Decimal("-50"), Decimal("300"), Decimal("-200")]
        assert_equal(
            np.mirr(val, Decimal("0.05"), Decimal("0.06")), Decimal("0.342823387842176663647819868")
        )
    ...
    def test_when(self):
        ...
        # begin
        assert_equal(
            np.pmt(0.08 / 12, 5 * 12, 15000.0, 0, 1), np.pmt(0.08 / 12, 5 * 12, 15000.0, 0, "begin")
        )
        # end
        assert_equal(
            np.pmt(0.08 / 12, 5 * 12, 15000.0, 0), np.pmt(0.08 / 12, 5 * 12, 15000.0, 0, "end")
        )
        assert_equal(
            np.pmt(0.08 / 12, 5 * 12, 15000.0, 0, 0), np.pmt(0.08 / 12, 5 * 12, 15000.0, 0, "end")
        )

        # begin
        assert_equal(
            np.ppmt(0.1 / 12, 1, 60, 55000, 0, 1), np.ppmt(0.1 / 12, 1, 60, 55000, 0, "begin")
        )
        # end
        assert_equal(np.ppmt(0.1 / 12, 1, 60, 55000, 0), np.ppmt(0.1 / 12, 1, 60, 55000, 0, "end"))
        assert_equal(
            np.ppmt(0.1 / 12, 1, 60, 55000, 0, 0), np.ppmt(0.1 / 12, 1, 60, 55000, 0, "end")
        )

        # begin
        assert_equal(
            np.ipmt(0.1 / 12, 1, 24, 2000, 0, 1), np.ipmt(0.1 / 12, 1, 24, 2000, 0, "begin")
        )
        # end
        ...
        # begin
        assert_equal(
            np.nper(0.075, -2000, 0, 100000.0, 1), np.nper(0.075, -2000, 0, 100000.0, "begin")
        )
        # end
        assert_equal(np.nper(0.075, -2000, 0, 100000.0), np.nper(0.075, -2000, 0, 100000.0, "end"))
        assert_equal(
            np.nper(0.075, -2000, 0, 100000.0, 0), np.nper(0.075, -2000, 0, 100000.0, "end")
        )
    ...
    def test_decimal_with_when(self):
        ...
        # begin
        assert_equal(
            np.rate(Decimal("10"), Decimal("20"), Decimal("-3500"), Decimal("10000"), Decimal("1")),
        ...
        assert_equal(
            np.rate(Decimal("10"), Decimal("20"), Decimal("-3500"), Decimal("10000"), Decimal("0")),
            np.rate(Decimal("10"), Decimal("20"), Decimal("-3500"), Decimal("10000"), "end"),
        )

        # begin
        assert_equal(
            np.pv(Decimal("0.07"), Decimal("20"), Decimal("12000"), Decimal("0"), Decimal("1")),
        ...
        assert_equal(
            np.pv(Decimal("0.07"), Decimal("20"), Decimal("12000"), Decimal("0"), Decimal("0")),
            np.pv(Decimal("0.07"), Decimal("20"), Decimal("12000"), Decimal("0"), "end"),
        )

        # begin
        assert_equal(
            np.fv(Decimal("0.075"), Decimal("20"), Decimal("-2000"), Decimal("0"), Decimal("1")),
        ...
        assert_equal(
            np.fv(Decimal("0.075"), Decimal("20"), Decimal("-2000"), Decimal("0"), Decimal("0")),
            np.fv(Decimal("0.075"), Decimal("20"), Decimal("-2000"), Decimal("0"), "end"),
        )
    ...
    def test_broadcast_decimal(self):
        ...
        assert_almost_equal(
            np.ipmt(Decimal("0.1") / Decimal("12"), list(range(5)), Decimal("24"), Decimal("2000")),
            [
                Decimal("-17.29165168"),
                Decimal("-16.66666667"),
                Decimal("-16.03647345"),
        ...
        assert_almost_equal(
            np.ppmt(Decimal("0.1") / Decimal("12"), list(range(5)), Decimal("24"), Decimal("2000")),
            [
                Decimal("-74.998201"),
                Decimal("-75.62318601"),
                Decimal("-76.25337923"),
