...
def loads(*args, **kwargs):
    ...
    warnings.warn(
        "np.loads is deprecated, use pickle.loads instead", DeprecationWarning, stacklevel=2
    )
        ...
        if member:
            ...
            if magic == format.MAGIC_PREFIX:
                ...
                return format.read_array(
                    bytes, allow_pickle=self.allow_pickle, pickle_kwargs=self.pickle_kwargs
                )
            else:
...
def load(file, mmap_mode=None, allow_pickle=False, fix_imports=True, encoding="ASCII"):
    ...
    with contextlib.ExitStack() as stack:
        ...
        if magic.startswith(_ZIP_PREFIX) or magic.startswith(_ZIP_SUFFIX):
            ...
            stack.pop_all()
            ret = NpzFile(
                fid, own_fid=own_fid, allow_pickle=allow_pickle, pickle_kwargs=pickle_kwargs
            )
            return ret
