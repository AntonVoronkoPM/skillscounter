...
def configuration(parent_package="", top_path=None):
    ...
    config.add_extension(
        ...
        depends=[join("src", "common", "mem_overlap.h"), join("src", "common", "npy_extint128.h")],
        libraries=["npymath"],
    )
    ...
    config.add_extension(
        "_struct_ufunc_tests", sources=[join("src", "umath", "_struct_ufunc_tests.c.src")]
    )
    ...
    config.add_extension(
        "_operand_flag_tests", sources=[join("src", "umath", "_operand_flag_tests.c.src")]
    )
