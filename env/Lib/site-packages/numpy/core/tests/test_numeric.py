...
class TestFromiter:
    ...
    def test_2592(self):
        ...
        count, eindex = 10, 5
        assert_raises(
            NIterError, np.fromiter, self.load_data(count, eindex), dtype=int, count=count
        )
...
class TestNonzero:
    ...
    def test_nonzero_onedim(self):
        ...
        x = np.array([(1, 2), (0, 0), (1, 1), (-1, 3), (0, 7)], dtype=[("a", "i4"), ("b", "i2")])
...
class TestStdVar:
    ...
    def test_ddof1(self):
        ...
        assert_almost_equal(
            np.std(self.A, ddof=1) ** 2, self.real_var * len(self.A) / float(len(self.A) - 1)
        )
    ...
    def test_ddof2(self):
        ...
        assert_almost_equal(
            np.std(self.A, ddof=2) ** 2, self.real_var * len(self.A) / float(len(self.A) - 2)
        )
