...
class NoseTester:
    ...
    def prepare_test_args(
        self, label="fast", verbose=1, extra_argv=None, doctests=False, coverage=False, timer=False
    ):
        """
    ...
    def test(
        ...
        with suppress_warnings("location") as sup:
            ...
            warnings.filterwarnings(
                "ignore", message=".*getargspec.*", category=DeprecationWarning, module=r"nose\."
            )
