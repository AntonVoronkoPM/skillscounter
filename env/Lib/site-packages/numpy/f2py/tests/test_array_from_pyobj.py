...
import pytest
from numpy import alltrue, array, clongdouble, dtype, intp, ndarray, zeros
...
if (intp().dtype.itemsize != 4 or clongdouble().dtype.alignment <= 8) and sys.platform != "win32":
    ...
    def __init__(self, typ, dims, intent, obj):
        ...
        if self.arr_attr[1] <= 1:
            assert_(
                ...
                repr(
                    (self.arr_attr[3], self.pyarr_attr[3], self.arr.tobytes(), self.pyarr.tobytes())
                ),
            )  # strides
        assert_(
...
class TestSharedMemory:
    ...
    def test_inplace_from_casttype(self):
        for t in self.type.cast_types():
            ...
            a.arr[1][2] = 54
            assert_(
                obj[1][2] == a.arr[1][2] == array(54, dtype=self.type.dtype), repr((obj, a.arr))
            )
            assert_(a.arr is obj)
